...
export const MotivationModule: React.FC = () => {
  console.log('🏆 MotivationModule: Componente carregado com sucesso');
  console.log('🏆 MotivationModule: Localização:', window.location.pathname);
