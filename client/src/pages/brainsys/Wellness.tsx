...
import { OptimizedComponentWrapper } from '@/components/common/OptimizedComponentWrapper';
import {
  Heart,
  Brain,
  AlertTriangle,
...
const WellnessContent: React.FC = () => {
  const [selectedDepartment, setSelectedDepartment] = useState('all');
  const [selectedTimeframe, setSelectedTimeframe] = useState('7d');
  const [isCreatingAction, setIsCreatingAction] = useState(false);

  // Mock data memoizado para o termômetro emocional - previne re-renders desnecessários
  const mockThermometers: WellnessThermometer[] = useMemo(() => [
    {
      id: '1',
      department: 'TI',
      overallScore: 72,
  ...
  // Mock data memoizado para ações recomendadas
  const mockActions: WellnessAction[] = useMemo(() => [
    {
      id: '1',
...
export const BrainSysWellness: React.FC = () => (
  <OptimizedComponentWrapper timeout={8000} moduleTitle="Bem-estar & Saúde Mental">
    <WellnessContent />
  </OptimizedComponentWrapper>
);

export default BrainSysWellness;