...
export const Checkout = () => {
  ...
  const { plan = 'Inicial', price = '127', billing = 'monthly' } = planData;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Falha na cobrança do cartão. Verifique os dados e tente novamente.",
        variant: "destructive",
      });
    } finally {
      setIsProcessing(false);
            ...
            <div className="lg:col-span-3">
              ...
              <Card className="mb-8 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border-green-200 dark:border-green-800">
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-xl text-gray-900 dark:text-white">Gestão Inteligente de Créditos</CardTitle>
                ...
                <CardContent>
                  <div className="grid gap-6 md:grid-cols-3">
                    <div className="text-center">
                      ...
                      <h4 className="font-semibold mb-2 text-gray-900 dark:text-white">1 Crédito = 1 Colaborador</h4>
                      ...
                      <div className="mt-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                        Cadastro completo: <span className="text-green-600 dark:text-green-400">1 crédito</span>
                      </div>
                    </div>
                    
                    <div className="text-center">
                      <div className="w-12 h-12 bg-purple-100 dark:bg-purple-950/40 rounded-full flex items-center justify-center mx-auto mb-3">
                        <Shield className="h-6 w-6 text-purple-600 dark:text-purple-400" />
                      </div>
                      <h4 className="font-semibold mb-2 text-gray-900 dark:text-white">Planos Flexíveis</h4>
                      <p className="text-sm text-muted-foreground dark:text-gray-400">
                        Escolha o plano ideal para o tamanho da sua empresa
                      </p>
                      <div className="mt-2">
                        <div className="text-xs text-muted-foreground dark:text-gray-400">Inicial: <span className="text-green-600 dark:text-green-400 font-medium">15 créditos</span></div>
                        <div className="text-xs text-muted-foreground dark:text-gray-400">Crescimento: <span className="text-green-600 dark:text-green-400 font-medium">75 créditos</span></div>
                        <div className="text-xs text-muted-foreground dark:text-gray-400">Profissional: <span className="text-green-600 dark:text-green-400 font-medium">500 créditos</span></div>
                      </div>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <h4 className="font-semibold mb-2 text-gray-900 dark:text-white">Controle Total</h4>
                      <p className="text-sm text-muted-foreground dark:text-gray-400">
